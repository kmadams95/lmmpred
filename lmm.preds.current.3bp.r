...
if (lmm1_ind==1 | lmm2_ind==1) {
  ...
  if (lmm1_ind==1) {
   ...
   pb <- progress_bar$new(
     ...
     total = n_eval_id, clear = FALSE, width= 60)
    ...
    cat('MEASUREMENTS FOR BP TYPE 1', '\n')
    ...
    cat('mean absolute difference=', mean_diff_1, '\n')
    cat('sd of mean absolute differences=', sd_diff_1, '\n')
    cat('--------------------------------------------','\n')
    
    cat('MEASUREMENTS FOR BP TYPE 2', '\n')
    ...
    cat('mean absolute difference=', mean_diff_2, '\n')
    cat('sd of mean absolute differences=', sd_diff_2, '\n')
    cat('--------------------------------------------','\n')
    
    cat('MEASUREMENTS FOR BP TYPE 3', '\n')
    ...
    cat('mean absolute difference=', mean_diff_3, '\n')
    cat('sd of mean absolute differences=', sd_diff_3, '\n')
    cat('--------------------------------------------','\n')
  }
  if (lmm2_ind==1) {
    #--------------------------------------------------------------------------
